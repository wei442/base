package com.cloud.provider.sms.core.aspectj;
...
public class BindResultAspect {
	 ...
	 * @throws Throwable
	 */
	@Before("execution(* com.cloud.provider.sms.controller.*.*(..))")
		...
		for (Object arg : args) {
			if (arg instanceof BindingResult) {
				...
				if (result.hasErrors()) {
					...
					throw new SmsException(SmsResultEnum.PARAMETER_EMPTY.getCode(), result.getFieldError().getDefaultMessage());
				}
			}
		}
	}
